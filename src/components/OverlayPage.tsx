      ...
      <AnimatePresence mode="wait">
        {nowPlaying && (
          ...
          >
            ...
            <div className="absolute -inset-20 bg-brand/20 blur-[120px] rounded-full mix-blend-screen animate-pulse" />
            ...
            <div className="relative w-36 h-36 rounded-[2rem] overflow-hidden shadow-2xl ring-2 ring-white/10 shrink-0">
              ...
              <div className="absolute bottom-4 left-4 p-2 bg-brand text-black rounded-xl shadow-lg">
            ...
            <div className="flex flex-col gap-3 min-w-0 pr-6 flex-1">
              <div className="flex items-center gap-3">
                 ...
                 <span className="text-[12px] font-black uppercase tracking-[0.4em] text-brand drop-shadow-sm">Now Playing</span>
              </div>
            ...
            <div className="absolute inset-x-0 bottom-0 h-2 bg-white/5">
                <motion.div 
                    className="h-full bg-brand shadow-[0_0_20px_var(--brand-color)]"
                    initial={{ width: 0 }}
          ...
          >
            ...
            <div className="flex flex-col gap-3 w-full">
              {topQueue.map((item, index) => (
                ...
                >
                  <span className="text-sm font-black text-brand/40 w-6 italic pl-2">{index + 1}</span>
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base font-bold text-white truncate group-hover/item:text-brand transition-colors tracking-tight">
                        {item.title}
                    </h3>
